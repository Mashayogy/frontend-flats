...
const TRANSLATIONS = {
    ru: {
        ...
        energy_low: "Низкая",
        energy_info: "Энергоэффективность жилья — это способность дома расходовать меньше энергии на отопление, охлаждение, освещение и работу бытовых систем, сохраняя при этом комфортную температуру и условия для жизни.\n\nВы можете фильтровать объекты по высокой эффективности (A+, A, B, B-), средней (C, D) или низкой (E, F).",
        env_park: "Парк рядом",
